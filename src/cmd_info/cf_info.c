...
static const RedisModuleCommandArg CF_RESERVE_ARGS[] = {
    ...
    { .name = "bucketsize",   .type = REDISMODULE_ARG_TYPE_INTEGER, .flags = REDISMODULE_CMD_ARG_OPTIONAL },
    { .name = "maxiterations",.type = REDISMODULE_ARG_TYPE_INTEGER, .flags = REDISMODULE_CMD_ARG_OPTIONAL },
    { .name = "expansion",    .type = REDISMODULE_ARG_TYPE_INTEGER, .flags = REDISMODULE_CMD_ARG_OPTIONAL },
    { 0 }
};
